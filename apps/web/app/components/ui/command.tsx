...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={cn(
          "top-[10svh] translate-y-0 gap-0 overflow-hidden rounded-xl! p-0 sm:max-w-3xl",
          className
        )}
        overlayClassName="supports-backdrop-filter:backdrop-blur-none bg-black/55"
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="border-b pr-10">
      <InputGroup className="h-14 rounded-none bg-transparent">
